...
func (m *postgresDBRepo) AllRooms() ([]models.Room, error) {
	...
	query := `select rm.id, rm.room_name, rm.created_at, rm.updated_at from "rooms" rm order by rm.room_name asc`
...
func (m *postgresDBRepo) GetRoomRestrictionsByDate(roomID int, startDate, endDate time.Time) ([]models.RoomRestriction, error) {
	...
	from "room_restrictions" where $1 <= start_date and end_date <= $2 and room_id = $3 order by start_date asc`
